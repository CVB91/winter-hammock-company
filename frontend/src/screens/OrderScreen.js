...
const OrderScreen = () => {
  ...
  useEffect(() => {
    ...
    if (!order || successPay || successDispatch) {
      dispatch({ type: ORDER_PAY_RESET }); // if this is not passed in the it will continually refresh
  ...
  }, [dispatch, order, orderId, successPay, successDispatch,navigate, userInfo]);
